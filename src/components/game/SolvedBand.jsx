...
export default function SolvedBand({ name, color, items, didYouKnow, initiallyOpen = true }) {
      ...
      <div className="band-main">
        ...
        {didYouKnow && (
          <button
            ...
            title="Dica de Saúde"
          >
            💡 {isOpen ? "Ocultar fato" : "Você Sabia?"}
          </button>
        )}
      </div>
      ...
      {didYouKnow && isOpen && (
        <div className="band-did-you-know" role="note">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <button className="tts-btn" onClick={speakFact} aria-label="Ouvir explicação">
