  ...
  return (
    <section className="screen screen--active">
      ...
      <p className="screen-subtitle">
        Escolha o tema que deseja estudar ou revisar agora.
      </p>
      ...
      <div
        className="tier-tabs"
        style={{
          display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "0.5rem", marginBottom: "1.5rem",
        }}
      >
        {tiersList.map((tier) => {
      ...
      <div className="sticky-actions" style={{ marginTop: "2rem" }}>
        ...
        >
          {!chosenThemeId ? "Selecione uma fase acima" : "Continuar para Dificuldade →"}
        </button>
      </div>
    </section>
  );
